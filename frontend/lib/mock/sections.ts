...
export const doc3Sections: DocumentSection[] = [
  ...
  },
  {
    ...
    documentId: "doc-3",
    sectionNumber: 2,
    heading: "2. Instrumented Safety Functions (SIF)",
    content: `# 2. Instrumented Safety Functions (SIF)\n\n## 2.1 SIF-101: ESD Initiator Logic\n\nThe primary initiator logic processes safety inputs with a 2oo3 voting architecture:\n- High-pressure transmitters (PT-101A/B/C)\n- Gas detection system (GDS) inputs\n- Manual emergency stops (ES-101/102/103)\n\n## 2.2 Response Times\n\n| SIF | Response Time | SIL | Action |\n|-----|--------------|-----|--------|\n| SIF-101 | < 2s | SIL 3 | Isolate feed lines |\n| SIF-102 | < 5s | SIL 2 | Depressurize vessels |\n| SIF-103 | < 1s | SIL 3 | Stop pumps |\n\n## 2.3 Proof Test Interval\n\nAll SIL 3 functions require proof testing every 6 months per IEC 61511-1.`,
    status: "draft",
    checklist: createDefaultChecklist(),
    evidenceImages: ["/mock-evidence/doc3-page3.png", "/mock-evidence/doc3-page4.png"],
    pageRange: { start: 3, end: 4 },
    currentVersion: {
      content: "Current version...",
      timestamp: "2026-02-19T07:10:00Z",
    },
    issues: [],
  },
  {
    ...
    documentId: "doc-3",
    sectionNumber: 3,
    heading: "3. Valve Actuator Specifications",
    content: `# 3. Valve Actuator Specifications\n\n## 3.1 Emergency Isolation Valves (EIV)\n\nAll emergency isolation valves are spring-return pneumatic actuators rated for cryogenic service:\n- Fail position: CLOSED\n- Actuation time: < 3 seconds\n- Operating temperature: -162°C to +65°C\n- Supply pressure: 5.5 – 8.0 bar\n\n## 3.2 EIV Valve List\n\n| Tag | Size | Cv | Line |\n|-----|------|----|------|\n| EIV-101 | 6\" | 285 | LNG Feed |\n| EIV-102 | 4\" | 145 | BOG Return |\n| EIV-103 | 8\" | 520 | Send-out |\n\n> **NOTE**: Actuation air supply must remain available during emergency events. Verify backup air supply pressure weekly.`,
    status: "draft",
    checklist: createDefaultChecklist(),
    evidenceImages: ["/mock-evidence/doc3-page5.png"],
  ...
  },
  {
    ...
    documentId: "doc-3",
    sectionNumber: 4,
    heading: "4. Testing and Maintenance Requirements",
    content: `# 4. Testing and Maintenance Requirements\n\n## 4.1 Functional Testing Schedule\n\nESD system functional tests must be performed per the following schedule:\n\n| Test Type | Frequency | Duration | Personnel |\n|-----------|-----------|----------|-----------|\n| Partial stroke test | Monthly | 2 hrs | Operations |\n| Full stroke test | 6 months | 8 hrs | Maintenance + Eng |\n| Functional safety assessment | 3 years | 3 days | Third-party SIS engineer |\n\n## 4.2 Documentation Requirements\n\nAll tests must be documented in the Safety Management System (SMS) with:\n- Test date and duration\n- As-found and as-left conditions\n- Any anomalies and corrective actions\n- Sign-off by qualified SIS engineer\n\n## 4.3 Bypass Management\n\nBypass of any SIF requires written approval from the Process Safety Manager. Maximum bypass duration: 8 hours. Compensating measures must be in place.`,
    status: "draft",
    checklist: createDefaultChecklist(),
    evidenceImages: ["/mock-evidence/doc3-page7.png", "/mock-evidence/doc3-page8.png"],
