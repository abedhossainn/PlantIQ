        ...
        return DocumentOptimizedChunksResponse(
            ...
            chunks=[
                OptimizedChunkResponse(
                    ...
                    row_refs=chunk.get("row_refs") or [],
                    entity_refs=chunk.get("entity_refs") or [],
                    relation_refs=chunk.get("relation_refs") or [],
                    source_lineage=chunk.get("source_lineage") or {},
                    retrieval_hints=chunk.get("retrieval_hints") or {},
                    path_ref=chunk.get("path_ref"),
                    parent_path_ref=chunk.get("parent_path_ref"),
                    node_type=chunk.get("node_type"),
                    value_type=chunk.get("value_type"),
                    value_state=chunk.get("value_state"),
                    path_depth=chunk.get("path_depth"),
                )
