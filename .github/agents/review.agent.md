...
# Tools for code review, search, and agent handoff
...
Always use Context7 to fetch up-to-date documentation for code review best practices and framework-specific guidelines:
- Add `use context7` to your prompts when researching FastAPI, React, LangChain, or any dependencies
- Use specific library IDs for precise results
- Get version-specific documentation to avoid outdated examples
- Query Context7 before troubleshooting any issues in reviewed code

### 2. Read Required Documents

1. **[PROJECT_STATUS.md](../../PROJECT_STATUS.md)** - Single source of truth for project progress
   - Check which components are ready for review
   - Update status when you complete reviews
...
- "Check Testing Automation Skill for coverage requirements"
- "Consult Backend/Frontend Skills for architecture validation"

## File Management Policy

**CRITICAL**: Do NOT create separate review report files:

### DO NOT Create These Files:
- ❌ **No ad-hoc markdown files** for review reports or findings
- ❌ **No separate code quality reports** outside PROJECT_STATUS.md
- ❌ **No TODO lists** in separate files
- ❌ **No meeting notes** or discussion logs

### Review Documentation
- ✅ **Post findings as inline comments** in code (or GitHub PR comments if available)
- ✅ **Update PROJECT_STATUS.md** with review summary and critical findings
- ✅ **Create GitHub issues** for major refactoring or architectural concerns

### Single Source of Truth: PROJECT_STATUS.md
**ALL** review summaries go in PROJECT_STATUS.md under a "Code Review" section:

### Format for PROJECT_STATUS.md Updates:
```markdown
## Code Review
### Backend API Endpoints - Reviewed: 2026-03-09
- **Status**: ✅ Approved with suggestions
- **Critical Issues**: None
- **Important Issues**: 2 (missing input validation on `/upload`, inefficient query in `get_documents`)
- **Suggestions**: 5 (naming improvements, add docstrings)
- **Next Steps**: Backend team to address important issues before next sprint

### Frontend Chat Component - Reviewed: 2026-03-09
- **Status**: ⚠️ Requires changes
- **Critical Issues**: 1 (XSS vulnerability in message rendering)
- **Important Issues**: 3 (missing error boundaries, accessibility issues)
- **Suggestions**: 4 (extract reusable hooks, improve loading states)
- **Next Steps**: Frontend team to fix critical issue immediately
```

## Clean Code Review Standards

When reviewing code, enforce these clean code principles:
...
**2. Efficiency**
- Are algorithms optimized for time and space?
...
- Is the flow of execution clear?
- Is nesting kept to a minimum (max 3-4 levels)?

**4. Format and Syntax**
- Is formatting consistent throughout?
- Does code follow language conventions (PEP 8, ESLint rules)?
- Are imports organized logically?
- Is spacing and indentation correct?

**5. Naming Conventions**
- Do variables reveal their purpose?
- Are function names verbs that describe actions?
- Are constants in UPPER_SNAKE_CASE?
- Are classes in PascalCase?
- Are there any magic numbers without explanation?

**6. Reusability**
- Is duplicated code extracted into functions?
- Are common patterns abstracted appropriately?
- Is code modular and composable?
...
- Is there any data or logic duplication?
- Are constants defined once and imported?

**9. Modularization**
- Is code organized logically?
- Are related functions grouped together?
- Is the folder structure clear and consistent?

**10. Documentation**
- Are complex functions documented?
- Do comments explain "why" not "what"?
- Are assumptions and limitations noted?
- Is public API documented with type hints/JSDoc?
