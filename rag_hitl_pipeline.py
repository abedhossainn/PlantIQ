...
from rag_validation_enhanced import create_validation_report, save_validation_report
from rag_section_review import (
    extract_sections_from_markdown,
    create_review_workspace,
    get_review_progress
)
from rag_qa_gates import (
    compute_qa_metrics,
    evaluate_qa_gate,
    save_qa_report,
    AcceptanceCriteria,
...
from rag_table_figure_handler import (
...
class HITLPipeline:
    ...
    def run_full_pipeline(
        ...
        try:
            ...
            from rag_vlm_comparison import compare_with_vlm
    ...
    def run_post_approval_reformatting(
        ...
        try:
            # Import reformatter
            from rag_text_reformatter import reformat_with_qwen
            import json
